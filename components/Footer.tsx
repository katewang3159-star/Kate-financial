  ...
  return (
    <section className="py-24 bg-morandi-lightCoral text-morandi-dark pb-40 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-4xl text-center relative z-10">
        ...
        <h2 className="text-3xl md:text-5xl font-serif font-light mb-8 leading-tight">讓阿蓉陪你<br/><span className="font-bold italic text-morandi-blue">在小資路上走得更安心</span></h2>
        ...
        <div className="border-t border-morandi-dark/10 pt-12">
          <p className="text-morandi-dark/60 text-xs tracking-[0.4em] uppercase mb-3 font-bold">阿蓉・小資理財管家</p>
