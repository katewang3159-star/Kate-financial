  ...
  return (
    <section className="py-24 bg-morandi-lightCoral text-morandi-dark pb-40 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-4xl text-center relative z-10">
        ...
        <h2 className="text-3xl md:text-5xl font-serif font-light mb-8 leading-tight">讓阿蓉陪妳<br/><span className="font-bold italic text-morandi-blue">在理財路上走得更安心</span></h2>
        
        {/* Steps */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-20 relative">
          {[
            { step: '01', title: '私訊阿蓉', desc: 'LINE 上打個招呼，隨便聊聊' },
            { step: '02', title: '雲端診斷', desc: '快速了解妳目前的財務狀況' },
            { step: '03', title: '專屬懶人包', desc: '給妳一份一看就懂的規劃書' }
          ].map((item, idx) => (
