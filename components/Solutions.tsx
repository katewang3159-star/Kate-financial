...
const Solutions: React.FC = () => {
  const services = [
    ...
    },
    {
      ...
      title: "旅遊與意外防護",
      desc: "愛生活、愛探索？便宜卻強大的意外傷害險，讓你出外通勤都心安。"
    },
    {
      icon: <PiggyBank className="w-7 h-7" />,
      title: "無痛老後現金流",
      desc: "複利就是你的超能力。現在開始規劃，為未來的自己準備一份優雅的禮物。"
    },
    {
      icon: <GraduationCap className="w-7 h-7" />,
      title: "專業保單大掃除",
      desc: "幫你檢查老舊保單。補足缺口、剔除過時項目，把錢省下來花在更有意義的地方。"
    }
  ];
    ...
    <section id="planning" className="py-24 bg-white">
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="text-center mb-20">
          ...
          <h2 className="text-3xl md:text-5xl font-serif font-bold text-morandi-dark">為你準備的<br/><span className="font-light text-morandi-coral">三大無痛規劃術</span></h2>
